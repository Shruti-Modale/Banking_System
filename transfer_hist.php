...
<html lang="en">
    ...
    <form  method="POST">
                <input type="text" name="id"  placeholder="Enter customer name" style = "height: 30px">
                <input type="submit" name="search" value="Search" style="background-color:#407ff5; color:white; height: 40px; font-weight:bold"> </br>
     </form>
